...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('v1')->group(function () {
        ...
        Route::patch('/user-words', [\App\Http\Controllers\Api\V1\UserWordController::class, 'store']);

        Route::get('/user-fill-in-the-blanks', [\App\Http\Controllers\Api\V1\UserFillInTheBlanksController::class, 'index']);
        Route::patch('/user-fill-in-the-blanks', [\App\Http\Controllers\Api\V1\UserFillInTheBlanksController::class, 'store']);
    });
});
